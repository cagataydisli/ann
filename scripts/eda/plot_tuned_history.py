# scripts/eda/plot_tuned_history.py
...
def main():
    # 1) Eğitim sırasında kaydedilen tuned model history objesini yükle
    ...
    plt.title("Tuned Model — Epoch’a Göre MSE Loss")
    plt.xlabel("Epoch")
    plt.ylabel("MSE Loss")
    plt.legend()
    plt.tight_layout()
    ...
    plt.title("Tuned Model — Epoch’a Göre MAE")
    plt.xlabel("Epoch")
